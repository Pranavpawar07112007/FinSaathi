    ...
    extend: {
      ...
      keyframes: {
        ...
        'move-circle-3': {
          ...
          '75%': { transform: 'translate(-40px, -20px) scale(1.0)' },
          '100%': { transform: 'translate(0, 0) scale(1)' },
        },
        'move-circle-4': {
          '0%': { transform: 'translate(0, 0) scale(1)' },
          '25%': { transform: 'translate(60px, 20px) scale(1.1)' },
      ...
      animation: {
        ...
        'move-circle-1': 'move-circle-1 30s ease-in-out infinite alternate',
        'move-circle-2': 'move-circle-2 25s ease-in-out infinite alternate',
